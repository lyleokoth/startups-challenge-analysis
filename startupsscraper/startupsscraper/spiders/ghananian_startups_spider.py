...
class GhananianSpider(scrapy.Spider):
    name = 'ghananian_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/Dbpf2fD3SDQQ_pr-vQYbAg/participations/2328/vote?order=alphabetical&scope=all'
    ]
