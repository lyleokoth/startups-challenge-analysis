...
class MalawianSpider(scrapy.Spider):
    name = 'malawian_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/o0govjL15Oj3TxAgFtSyjA/participations/5312/vote?order=alphabetical&scope=all'
    ]
