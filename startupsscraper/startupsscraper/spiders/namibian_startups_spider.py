...
class NamibianSpider(scrapy.Spider):
    name = 'namibian_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/ezBx99eP2s96PNCHZNIs8A/participations/23799/vote?order=alphabetical&scope=all'
    ]
