...
class ZimbabweanSpider(scrapy.Spider):
    name = 'zimbabwean_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/O-sX9rpVlpX_KkJ6ovHnvw/participations/24110/vote?order=alphabetical&scope=all'
    ]
