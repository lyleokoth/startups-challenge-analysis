...
class NigerianSpider(scrapy.Spider):
    name = 'nigerian_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/2Z6qAlbiMPxEwtQnOcojog/participations/4622/vote?order=alphabetical&scope=all'
    ]
