...
class EthiopianSpider(scrapy.Spider):
    name = 'ethiopian_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/dTDS04gJZ9Z56COMzodc0g/participations/22706/vote?order=alphabetical&scope=all'
    ]
