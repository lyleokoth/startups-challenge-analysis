...
class EswatiniSpider(scrapy.Spider):
    name = 'eswatini_startups'

    start_urls = [
        'https://startupper.totalenergies.com/en/juries/MRZ3rX3Wl3uGfRvGD3rwLA/participations/2361/vote?order=alphabetical&scope=all'
    ]
